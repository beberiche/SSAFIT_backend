...
VALUES	
    ...
    (0, "2swcod5RYvU", "배고픈 춘식", "이보게 레오!! 운동하고 먹는밥은 꿀맛이야!", "choonsik", NOW()),
    (0, "2swcod5RYvU", "먼저먹은 해피", "운동 하고 계동 ㄱㄱ", "happy", NOW()),
    (0, "2swcod5RYvU", "싸피싸피", "나도 나도!!", "ssafy", "2020-02-11 03:11:22"),
    (0, "2swcod5RYvU", "x카오 라이언", "여기가 싸핏입니까?", "reo", NOW()),
    (0, "2swcod5RYvU", "방황하는 에이젯", "제일 힘든게 더미데이터 만드는거다", "galaxy", NOW()),
    (0, "2swcod5RYvU", "해킹 당한 시리", "빅스비 나와", "apple", NOW()),
	(0,'2swcod5RYvU', '굿뜨', '굿굿', 'ssafy', '2022-04-19 14:28:50'),
	(0,'2swcod5RYvU', '2학기엔 헬스 다닌다 진짜', '손목 건다', 'galaxy', '2022-04-19 14:28:51'),
	(0,'2swcod5RYvU', '홍xx쌤', '응 저 불렀어요??', 'ssafy', '2022-04-11 14:28:50'),
    (0,'2swcod5RYvU', '양xx쌤', 'ㅋㅋㅋ 영구 박제박제', 'ssafy', '2022-04-11 14:28:50'),
    (0,'2swcod5RYvU', '손xx쌤', '여러분 초면에 죄송한데 10분만 더할께요 x6', 'ssafy', '2022-04-11 14:28:50'),
...
VALUES
    (0, 1,"헝그리 복서", "그게바로 헝그리정신...", "choonsik", NOW()),
    (0, 1, "해적왕", "원피스 언제끝나??", "happy", "2020-04-27 23:22:11"),
    (0, 1, "에드시러", "yeah yeah yeah i need girl like you", "galaxy", '2018-09-28 11:02:31'),
    (0, 1, "로파이코팅","둠두두두둠둠", "ssafy", "2011-02-22 19:04:00"), 
    (0, 1, "블랙핑크광팬", "두릅두릅두릅", "coffee", "2018-04-11 15:11:22"),
    (0, 1, "엘런튜링", "과거에서 보내는 메시지", "ssafy", "2000-02-21 12:23:11"),
